...
public class BadgeService {
    ...
    public static Integer calculatePercentage(Buyer buyer) {
        // Badge decrease commision
        Double commissionPercentage = buyer.getCommissionPercentage() + 0.0;
    ...
    public static Integer calculatePercentage(Seller seller, List<Badge> badges) {
        // Badge decrease commision
        Double commissionPercentage = seller.getCommissionPercentage() + 0.0;
